...
class Config():
    ...
    filename_glove = "data/wiki.zh.glove.txt"
    
    # trimmed embeddings (created from glove_filename with build_data.py)
    #filename_trimmed = "data/glove.6B.{}d.trimmed.npz".format(dim_word)
    filename_trimmed = "data/wiki.zh.glove.trimmed.npz".format(dim_word)
    use_pretrained = True
    ...
    filename_dev ="data/var_chinese_no_space.txt"
    filename_test = "data/test_chinese_no_space.txt"
    filename_train = "data/train_chinese_no_space.txt" # test
